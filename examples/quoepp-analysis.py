...
hot_pixels = np.array([(7,103),(178,226),(182,150),(114,160),(116,199),(103,198),(76,166),(55,203),(121,97),(249,56),(150,176),(197,223),(166,57),(124,229),(87,178),(89,170),(122,103),(165,155),(165,112),(114,116),(165,115)])
...
def main(process_path):
    ...
    ax[0][0].grid(True)
    ax[0][0].plot(edge[2:-1]/1e7, hist_sum[2:], drawstyle= 'steps-pre')
    ...
    plt.savefig(process_path+'\\'+name+'.png')
...
if __name__ == '__main__':
    while True:
        try:
            process_path = str(filedialog.askdirectory())
            main(process_path)
        except Exception as e: 
            print(e)
            break
